...
module Paths' = struct
  ...
  let postWebhookEndpoints () =
    Routes.(s "v1" / s "webhook_endpoints" /? nil)
  ...
  let postClimateOrders () =
    Routes.(s "v1" / s "climate" / s "orders" /? nil)
  ...
  let getBalanceHistory () =
    Routes.(s "v1" / s "balance" / s "history" /? nil)
  ...
  let postBillingMeters () =
    Routes.(s "v1" / s "billing" / s "meters" /? nil)
  ...
  let postCustomerSessions () =
    Routes.(s "v1" / s "customer_sessions" /? nil)
  ...
  let getProductsSearch () =
    Routes.(s "v1" / s "products" / s "search" /? nil)
  ...
  let getInvoicesSearch () =
    Routes.(s "v1" / s "invoices" / s "search" /? nil)
